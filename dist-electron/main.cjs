...
var require_follow_redirects = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function wrap(protocols) {
		...
		Object.keys(protocols).forEach(function(scheme) {
			...
			var wrappedProtocol = exports$2[scheme] = Object.create(nativeProtocol);
			function request(input, options, callback) {
				...
				options = Object.assign({
					maxRedirects: exports$2.maxRedirects,
					maxBodyLength: exports$2.maxBodyLength
				}, input, options);
...
//#endregion
//#region node_modules/kovaaks-api-client/dist/client.js
var require_client = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	var KovaaksApiError = class extends Error {
	...
	*/
	var KovaaksApiClient = class {
		constructor(options = {}) {
			...
			if (options.authToken) this.setAuthToken(options.authToken);
			this.client.interceptors.response.use((response) => response, (error) => {
				var _a, _b, _c, _d;
				throw new KovaaksApiError(((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error) || error.message || "Unknown error", ((_c = error.response) === null || _c === void 0 ? void 0 : _c.status) || 500, (_d = error.response) === null || _d === void 0 ? void 0 : _d.data);
			});
		}
		/**
		...
		*/
		buildUrl(path, params = {}) {
			...
			Object.entries(params).forEach(([key, value]) => {
				if (value !== void 0 && value !== null) if (Array.isArray(value)) value.forEach((v) => url.searchParams.append(`${key}[]`, String(v)));
		...
		*/
		async request(config) {
			try {
				...
				if (error instanceof KovaaksApiError) throw error;
		...
		async getPlaylistByCode(params) {
		...
		async getScenariosPlayedByUsername(params) {
			...
			if (params.sort) queryParams["sort_param[]"] = params.sort;
			return this.request({
				method: "GET",
...
//#endregion
//#region node_modules/kovaaks-api-client/dist/types.js
var require_types = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.ScenarioLeaderboardScoreSearch = exports.FeaturedHighScores = exports.GetScenariosPlayedByUsernameSortedByPlays = exports.GetBenchmarkProgressForWebappUsername = exports.SearchScenariosByScenarioName = void 0;
	var SearchScenariosByScenarioName;
	(function(SearchScenariosByScenarioName) {
		(function(AimType) {
			AimType["Clicking"] = "Clicking";
			AimType["TargetSwitching"] = "Target Switching";
			AimType["Tracking"] = "Tracking";
		})(SearchScenariosByScenarioName.AimType || (SearchScenariosByScenarioName.AimType = {}));
	})(SearchScenariosByScenarioName || (exports.SearchScenariosByScenarioName = SearchScenariosByScenarioName = {}));
	var GetBenchmarkProgressForWebappUsername;
	(function(GetBenchmarkProgressForWebappUsername) {
		(function(RankName) {
			RankName["DiamondIII"] = "Diamond III";
			RankName["NoRank"] = "No Rank";
			RankName["The05"] = "0/5";
		})(GetBenchmarkProgressForWebappUsername.RankName || (GetBenchmarkProgressForWebappUsername.RankName = {}));
		(function(Type) {
			Type["Benchmark"] = "benchmark";
			Type["Workout"] = "workout";
		})(GetBenchmarkProgressForWebappUsername.Type || (GetBenchmarkProgressForWebappUsername.Type = {}));
	})(GetBenchmarkProgressForWebappUsername || (exports.GetBenchmarkProgressForWebappUsername = GetBenchmarkProgressForWebappUsername = {}));
	var GetScenariosPlayedByUsernameSortedByPlays;
	(function(GetScenariosPlayedByUsernameSortedByPlays) {
		(function(FovScale) {
			FovScale["Horizontal43"] = "Horizontal (4:3)";
			FovScale["Overwatch"] = "Overwatch";
		})(GetScenariosPlayedByUsernameSortedByPlays.FovScale || (GetScenariosPlayedByUsernameSortedByPlays.FovScale = {}));
		(function(Resolution) {
			Resolution["The1600X900"] = "1600x900";
			Resolution["The1920X1080"] = "1920x1080";
		})(GetScenariosPlayedByUsernameSortedByPlays.Resolution || (GetScenariosPlayedByUsernameSortedByPlays.Resolution = {}));
		(function(SensScale) {
			SensScale["CM360"] = "cm/360";
			SensScale["Overwatch"] = "Overwatch";
			SensScale["QuakeSource"] = "Quake/Source";
		})(GetScenariosPlayedByUsernameSortedByPlays.SensScale || (GetScenariosPlayedByUsernameSortedByPlays.SensScale = {}));
	})(GetScenariosPlayedByUsernameSortedByPlays || (exports.GetScenariosPlayedByUsernameSortedByPlays = GetScenariosPlayedByUsernameSortedByPlays = {}));
	var FeaturedHighScores;
	(function(FeaturedHighScores) {
		(function(ClientBuildVersion) {
			ClientBuildVersion["The37720250421102618Ebda1827461E"] = "3.7.7.2025-04-21-10-26-18-ebda1827461e";
		})(FeaturedHighScores.ClientBuildVersion || (FeaturedHighScores.ClientBuildVersion = {}));
		(function(Scale) {
			Scale["CM360"] = "cm/360";
			Scale["CallOfDuty"] = "Call of Duty";
			Scale["Overwatch"] = "Overwatch";
			Scale["Valorant"] = "Valorant";
		})(FeaturedHighScores.Scale || (FeaturedHighScores.Scale = {}));
		(function(Model) {
			Model["None"] = "None";
		})(FeaturedHighScores.Model || (FeaturedHighScores.Model = {}));
		(function(Resolution) {
			Resolution["The1600X900"] = "1600x900";
			Resolution["The1920X1080"] = "1920x1080";
			Resolution["The2560X1440"] = "2560x1440";
		})(FeaturedHighScores.Resolution || (FeaturedHighScores.Resolution = {}));
		(function(Game) {
			Game["Aimerz"] = "aimerz";
			Game["Cs2"] = "CS2";
			Game["KovaaKS"] = "KovaaK's";
			Game["KovaaKs"] = "KovaaKs";
			Game["Valorant"] = "Valorant";
		})(FeaturedHighScores.Game || (FeaturedHighScores.Game = {}));
	})(FeaturedHighScores || (exports.FeaturedHighScores = FeaturedHighScores = {}));
	var ScenarioLeaderboardScoreSearch;
	(function(ScenarioLeaderboardScoreSearch) {
		(function(Hash) {
			Hash["The18505Db399Aaa604B7A65Fa03Ffa7490"] = "18505db399aaa604b7a65fa03ffa7490";
		})(ScenarioLeaderboardScoreSearch.Hash || (ScenarioLeaderboardScoreSearch.Hash = {}));
		(function(Model) {
			Model["None"] = "None";
		})(ScenarioLeaderboardScoreSearch.Model || (ScenarioLeaderboardScoreSearch.Model = {}));
		(function(Resolution) {
			Resolution["The1280X960"] = "1280x960";
			Resolution["The1600X900"] = "1600x900";
			Resolution["The1680X1050"] = "1680x1050";
			Resolution["The1920X1080"] = "1920x1080";
			Resolution["The2560X1440"] = "2560x1440";
		})(ScenarioLeaderboardScoreSearch.Resolution || (ScenarioLeaderboardScoreSearch.Resolution = {}));
	})(ScenarioLeaderboardScoreSearch || (exports.ScenarioLeaderboardScoreSearch = ScenarioLeaderboardScoreSearch = {}));
}));
//#endregion
//#region node_modules/kovaaks-api-client/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "KovaaksApiClient", {
		enumerable: true,
		get: function() {
			return client_1.KovaaksApiClient;
		}
	});
	Object.defineProperty(exports, "KovaaksApiError", {
		enumerable: true,
		get: function() {
			return client_1.KovaaksApiError;
		}
	});
	__exportStar(require_types(), exports);
}));
//#endregion
//#region electron/main.cjs
var { app, BrowserWindow, ipcMain, protocol, net } = require("electron");
var path = require("path");
var { pathToFileURL } = require("url");
var { KovaaksApiClient } = require_dist();
var kovaaks = new KovaaksApiClient();
var mainWindow;
...
app.whenReady().then(() => {
	protocol.handle("app", (request) => {
		let requestUrl = request.url.slice(7);
		requestUrl = requestUrl.split("?")[0].split("#")[0];
		if (!requestUrl || requestUrl === "/") requestUrl = "index.html";
		else if (requestUrl.startsWith("/")) requestUrl = requestUrl.substring(1);
...
ipcMain.handle("getRecentActivity", async (event, username) => {
	try {
		return {
			success: true,
			data: await kovaaks.getRecentHighScoresByUsername({ username })
		};
	} catch (error) {
		return {
			success: false,
...
ipcMain.handle("getProfile", async (event, username) => {
	try {
		return {
			success: true,
			data: await kovaaks.getProfileByUsername({ username })
		};
	} catch (error) {
		return {
			success: false,
...
ipcMain.handle("getScenarioScore", async (event, username, scenarioName) => {
	try {
		return {
			success: true,
			data: await kovaaks.getLastScoresByScenarioName({
				username,
				scenarioName
			})
		};
